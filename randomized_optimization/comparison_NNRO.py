...
if __name__ == "__main__":
    ...
    # Select model
    model_candidates = {
        "Gradient Descent": (NeuralNetwork, {"hidden_nodes": [[64]]}),
        "RHC": (NeuralNetwork, {"hidden_nodes": [[64]],
                                       "restarts": [20]}),
        "SA": (NeuralNetwork, {"hidden_nodes": [[64]],
        ...
        "GA": (NeuralNetwork, {"hidden_nodes": [[64]],
                                      "pop_size": [300],
    ...
    compare(X_train, X_test, y_train, y_test, models, dataset_name="MNIST", scorer=scorer, n_jobs=-2)
    ...
    compare(X_train, X_test, y_train, y_test, models, dataset_name="Wine Quality", scorer=scorer, n_jobs=-2)
